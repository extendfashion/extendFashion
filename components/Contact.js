        ...
        <section id="contact" className="contact">
            <div className="container mx-auto">
                <div className="contactWrapper w-11/12 m-auto">
                    <SectionHead subTitle="Get In Touch" titleFirst="C" titleLast="ontact Us" />

                    <div className="contactWrapper w-fit mx-auto grid sm:grid-cols1 md:grid-cols-2 lg:grid-cols-2 gap-y-8 gap-x-12">
                        <div className="contactBoxnTitle">

                            <div className="contactCardtTitle"><h1 className="navLogo font-semibold text-xl mb-4 text-left">T<span className="text-white">alk To Us</span></h1></div>
                        ...
                        <div className="contactFeildnTitle">
                            <div className="contactCardtTitle"><h1 className="navLogo font-semibold text-xl mb-4 text-left">S<span className="text-white">end Us an E-mail</span></h1></div>
